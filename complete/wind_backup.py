...
#             insert_query = "INSERT INTO WEATHER_MEASUREMENT (WIND_DIRECTION_MIN, WIND_DIRECTION_AVG, WIND_DIRECTION_MAX, WIND_SPEED_MIN, WIND_SPEED_AVG, WIND_SPEED_MAX) VALUES (%u,%u,%u,%i,%i,%i);", (dir_min, dir_avg, dir_max, speed_min, speed_avg, speed_max)
